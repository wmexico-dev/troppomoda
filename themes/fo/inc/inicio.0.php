...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $xtp?>/css/gxnav.css" />
<?php if (!$c->isEditMode()) {?>
...
<?php }?>
    ...
    <script type="text/javascript" src="<?php echo $xtp?>/js/gxnav.js"></script>
...
<?php if($u->isSuperUser() || $u->inGroup($xga)) echo'<li><a href="/_admin/"><i class="fa fa-pencil"></i> Admin</a></li>';?>
    <li><a href="/newsletter/"><i class="fa fa-envelope"></i> Subscribirse al Newsletter</a></li>
<?php 
    if(empty($xrEmail)) echo'<li><a href="/registro/"><i class="fa fa-user"></i> Inicio/Registro</a></li>';
    else  echo'<li><a href="" onClick="return false"><i class="fa fa-user"></i>  '.$xrEmail.'</a><ul><li><a href="/registro/salir/">Salir</a></li></ul></li>';   
?>
</ul>
<?php if($u->isSuperUser() || !empty($xrEmail)) {?>
<div id="compras0">
...
if(!empty($M)) {
    echo '<ul><li><a href="/tienda/">Todos los artículos</a></li>';
    foreach($M as $X) echo'<li><a href="/tienda/categoria/'.$X['cIdent'].'/">'.$X['cNombre']."</a></li>";
    echo '</ul>';
}?>
        </li>
<?php
